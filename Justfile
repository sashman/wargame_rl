...
behaviour-clone policy env_config n_episodes='200' epochs='8' out='checkpoints/clone.ckpt':
	@uv run python -m scripts.behaviour_clone {{policy}} {{env_config}} {{n_episodes}} {{epochs}} {{out}}
