    ...
    **divergent**, approximated by one `group_max_distance` and priced by the
    ...
    enforce_move: str = Field(
        ...
        description=(
            ...
            "The no-gradient argument is specific to the two revert modes: they "
            "*alias*, mapping every illegal joint action to one outcome. "
            "`repair` does not -- different illegal actions produce different "
            "repaired configurations -- so training under it is an open "
            "question rather than a settled null. It has not been tried.\n\n"
