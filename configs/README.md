...
| `curriculum/a5_hold.yaml` | #340 A5 **arm A5e**: `a5.yaml` plus `objective_hold` at `crowding_exponent` 1.0 (S1's term), trained under `--credit actor` where the close pays each body its own value of it on its own step — the state-credit half of the actor build, which A5's own reward (no state term) cannot test. Bar unchanged. Pre-registered 2026-09-18. |
| `curriculum/a5_bodies.yaml` | #340 half-step **A5-bodies**: A5's twenty-four bodies in eight squads over A4's THREE points at x=35 (bodies doubled from A4, points held). Bar `squad_march_take` 1.000 / held 3.00 / 4.43 turns, both facades identical, 2026-09-18. Pre-registered with A5-points. |
| `curriculum/a5_points.yaml` | #340 half-step **A5-points**: six squads of three (eighteen bodies) over FIVE points, A5's near column and a far column of two (points raised, bodies less than doubled). Bar `squad_march_take` 1.000 / held 5.00 / 6.71 turns, both facades identical, 2026-09-18. Pre-registered with A5-bodies. |
