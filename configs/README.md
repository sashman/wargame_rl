...
|---|---|
| `curriculum/a3.yaml` | #340 rung **A3**, the spread rung: four squads, four objectives, success `all_objectives_occupied`. Bar `squad_march_take` 1.000 / held 4.00 / 5.28 turns. Control passes 3 of 3 at 120 epochs (extended once); **per-model FAIL as pre-registered at the cap (0.70 / 0.80 / 0.77, still rising)**; A3x resumes to 245k, 2026-09-15. |
