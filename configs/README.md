...
| `curriculum/a3_hold.yaml` | #340 A3 **speed arm S1**: `a3.yaml` plus `objective_hold` at `crowding_exponent` 1.0 — the one change. Pre-registered 2026-09-15 (`reports/2026-09-15-curriculum-A3-speed-preregistration.md`); bar identical to `a3.yaml`. |
| `curriculum/a3_match.yaml` | #340 A3 **speed arm S2**: `a3.yaml` with the travel term's assignment a matching (`one_objective_per_group`) — the one change. Pre-registered 2026-09-15; one unit owning 2+ points 49.1% → 0.0% of steps for the bar. |
