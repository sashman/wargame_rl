...
|---|---|
| `curriculum/a5.yaml` | #340 rung **A5**: eight squads, six objectives, ten rounds, every point occupied. Bar `squad_march_take` 1.000 / held 6.00 / 6.77 turns. **The whole-army control fails 2 of 3 at 120 epochs** by leaving a point empty (NULL as pre-registered, the clause wrong); A5b runs the per-model arm, 2026-09-15. |
