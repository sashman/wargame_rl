...
|---|---|
| `curriculum/a2.yaml` | #340 rung **A2**: four squads, one objective of radius 6, success at 75% on the point. Bar `squad_march_take` 0.990 / 4.55 turns. Control passes 3 of 3; **per-model FAIL as pre-registered — 1.000 ×3 at 10k rounds, drifted to 0.37 / 0.88 / 0.98 at 123k**; A2b (`ent_coef` 0.003) running, 2026-09-15. |
