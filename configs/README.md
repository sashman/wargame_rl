...
|---|---|
| `curriculum/a4.yaml` | #340 rung **A4**: four squads, three objectives (a spare squad). Bar `squad_march_take` 1.000 / held 3.00 / 4.70 turns. Control passes 3 of 3 at 60 epochs; **per-model FAIL at the cap (0.93 / 0.93 / 0.97, one SE short and rising)**; A4x resumes to 245k, 2026-09-15. |
